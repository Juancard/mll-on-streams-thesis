...
\begin{figure}
	\includegraphics[width=\linewidth,height=10cm]{figures/experiments/f1_ex.png}
...
\begin{figure}
	\includegraphics[width=\linewidth,height=10cm]{figures/experiments/f1_macro.png}
...
\begin{figure}
	\includegraphics[width=\linewidth,height=10cm]{figures/experiments/f1_micro.png}
	\caption{Comparativa de modelos bajo la métrica \textit{f1} con promedio

...
\begin{figure}[htbp]
	...
	\subfloat[Distribución de etiquetas para 20ng][Distribución de etiquetas para 20ng]{
		\includegraphics[width=\textwidth]{figures/experiments/syn/20ng/label_distribution.png}}
	\qquad
	\centering
	\subfloat[Distribución de etiquetas para 20ng - \textit{MAE}][Distribución
		de etiquetas para 20ng - \textit{MAE}]{
		\includegraphics[width=\textwidth]{figures/experiments/syn/20ng/ld_mae.png}}
...
\begin{figure}[htbp]
	...
	\subfloat[Relación entre etiquetas para 20ng - \textit{Stream} original.][\textit{Stream} original.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/20ng/20ng_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para 20ng - \textit{Stream}
		JC.][\textit{Stream} JC.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/20ng/JC_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para 20ng - \textit{Stream}
		JC\_BIG.][\textit{Stream} JC\_BIG.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/20ng/JC_BIG_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para 20ng - \textit{Stream}
		MOA.][\textit{Stream} MOA.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/20ng/MOA_relationship_graph.png}}
...
\begin{figure}[htbp]
	...
	\subfloat[Relación entre etiquetas para Enron - \textit{Stream} original.][\textit{Stream} original.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/enron/enron_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Enron - \textit{Stream}
		JC.][\textit{Stream} JC.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/enron/JC_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Enron - \textit{Stream}
		JC\_BIG.][\textit{Stream} JC\_BIG.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/enron/JC_BIG_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Enron - \textit{Stream}
		MOA.][\textit{Stream} MOA.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/enron/MOA_relationship_graph.png}}
	\caption[Relación entre etiquetas para cada \textit{stream} generado sobre
...
\begin{figure}[htbp]
	...
	\subfloat[Relación entre etiquetas para Mediamill - \textit{Stream} original.][\textit{Stream} original.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/mediamill/mediamill_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Mediamill - \textit{Stream}
		JC.][\textit{Stream} JC.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/mediamill/JC_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Mediamill - \textit{Stream}
		JC\_BIG.][\textit{Stream} JC\_BIG.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/mediamill/JC_BIG_relationship_graph.png}}
	\qquad
	\subfloat[Relación entre etiquetas para Mediamill - \textit{Stream}
		MOA.][\textit{Stream} MOA.]{
		\includegraphics[width=0.4\textwidth]{figures/experiments/syn/mediamill/MOA_relationship_graph.png}}
	\caption[Relación entre etiquetas para cada \textit{stream} generado sobre

...
El resultado de los métodos propuestos muestra que son competitivos respecto a
la literatura de referencia. En particular, para las pruebas realizadas con el
conjunto de datos 20NG los valores de F-Score basado en ejemplos obtenidos
superan en 2.3\% a \cite{osojnik_multi-label_2017} pero no son mejores que otros
como \cite{sousa_multi-label_2018, buyukcakir_novel_2018,

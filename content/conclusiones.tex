...
colecciones de tipo \comillas{A}, es decir, colecciones donde la mayoría de las
...
mayor para las colecciones de tipo \comillas{A} (20ng) que para las de tipo
\comillas{B} (Enron y Mediamill). No obstante, es necesario realizar más
...
\begin{itemize}
	...
	\item Se ha mencionado anteriormente que el uso de la matriz de
	      ...
	      \comillas{A} como 20ng. Para confirmar esta suposición, un enfoque
	      ...
	      colecciones de tipo \comillas{B}.

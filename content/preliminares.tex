...
\textit{Naive} Bayes de la siguiente manera: \todo{m = clases pero en
las siguientes secciones m = instancias} 
...
\end{equation} \todo{m = clases. Misma consideración que en naive bayes}
